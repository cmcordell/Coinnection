...
public class Constants {
    ...
    public static final long RELOAD_TIME_SINGLE_ASSET = 5 * 60 * 1000; //5 min
    public static final long RELOAD_TIME_ALL_ASSETS = 15 * 60 * 1000; //15 min
    public static final long RELOAD_TIME_NETWORK_CHECK = 1000; //1 sec
    ...
    public static final String KEY_DATA_UPDATE = "pref_data_refresh";
    @Retention(SOURCE)
    @StringDef( {DATA_UPDATE_ONE_DAY, DATA_UPDATE_TWO_DAY, DATA_UPDATE_THREE_DAY,
                 DATA_UPDATE_ONE_WEEK, DATA_UPDATE_ONE_MONTH, DATA_UPDATE_NEVER} )
    public @interface DataRefresh{}
    public static final String DATA_UPDATE_ONE_DAY = "1";
    public static final String DATA_UPDATE_TWO_DAY = "2";
    public static final String DATA_UPDATE_THREE_DAY = "3";
    public static final String DATA_UPDATE_ONE_WEEK = "7";
    public static final String DATA_UPDATE_ONE_MONTH = "30";
    public static final String DATA_UPDATE_NEVER = "0";
